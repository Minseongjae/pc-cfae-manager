...
import { DEFAULT_STORE_NAME } from '@/lib/appBrand';
...
export function Sidebar({ currentPage, onNavigate, className = '', onClose }: SidebarProps) {
  ...
  const storeName = settings.store.name || DEFAULT_STORE_NAME;
        ...
        <div className="flex items-center justify-between gap-3">
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              <h1 className="heading-display text-base leading-tight">{storeName}</h1>
